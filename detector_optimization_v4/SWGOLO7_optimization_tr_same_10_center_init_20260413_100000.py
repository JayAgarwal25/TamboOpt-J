...
output_dir = "./outputs/NN_Files_36_10_shower_center_init"
...
for epoch in range(num_epoch, num_epoch + 1000):
    ...
    U_e_vals.append(   (1e8 * U_E(preds_e, energy, r_score)).item() )
...
plt.plot([u for u in U_e_vals],   label='1e8 U_E',    lw=1)
