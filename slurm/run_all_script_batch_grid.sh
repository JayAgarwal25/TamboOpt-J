...
#SBATCH -J run_all_script_batch_grid
...
STATUS_FILE="pipeline_status_grid.json"
...
run_step 04_optimize_lbfgs_ensemble.py --schemes grid --chains 6
run_step 04_optimize_lbfgs_activation.py --schemes grid --chains 1
