...
TRAINING_DATASET_FOLDER = os.path.join(RUN_LOCATION, "v6_run_01")
FNN_FOLDER = os.path.join(RUN_LOCATION, "v6_run_02")
RECON_FOLDER = os.path.join(RUN_LOCATION, "v6_run_03")
